	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="family/informationUpdate" method="POST"
					onsubmit="return checkSubmit();">
					<input type="hidden" name="id" value="${family['id'] }">
					<ul class="forminfo">
						<li><label>成员名称<b>*</b></label><input id="name" value="${family['name'] }"
							name="name" type="text" class="dfinput" placeholder="请填写成员名称"
