	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="income/informationAdd" method="POST"
					onsubmit="return checkSubmit();">
					<input type="hidden" name="user_id" value="${sessionScope['User']['id'] }">
					<ul class="forminfo">
						<li><label>收入金额<b>*</b></label><input id="price" onkeyup="value=value.replace(/[^\d.]/g,'')"
							name="price" type="text" class="dfinput" placeholder="请填写收入金额"
							style="width: 518px;" /></li>
						<li><label>收入时间<b>*</b></label><input id="come_date" 
