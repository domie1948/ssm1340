	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="typee/informationUpdate" method="POST"
					onsubmit="return checkSubmit();">
					<input type="hidden" name="id" value="${typee['id'] }">
					<ul class="forminfo">
						<li><label>科目名称<b>*</b></label><input id="name" value="${typee['name'] }"
							name="name" type="text" class="dfinput" placeholder="请填写类型名称"
							style="width: 518px;" /></li>
						<li><label>科目种类<b>*</b></label><div class="vocation">
						<select class="select3" name="type" id="type">
									<c:if test="${typee['type'] eq 1}" var="s1">
										<option value="1" selected="selected">收入</option>
									</c:if>
									<c:if test="${!s1}">
										<option value="1">收入</option>
									</c:if>
									<c:if test="${typee['type'] eq 2}" var="s2">
